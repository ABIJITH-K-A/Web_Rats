          ...
          <div className="flex-1">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-cyan-primary px-4 py-2.5 text-sm font-semibold text-primary-dark transition-all hover:bg-cyan-primary/90"
              >
                <Check size={16} />
                Accept
              </button>
