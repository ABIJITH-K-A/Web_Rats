...
const BookService = () => {
  ...
  return (
    <div className="container mx-auto px-6 pt-12 pb-32">
      ...
      <div className="max-w-4xl mx-auto overflow-hidden min-h-[500px]">
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {selectedService.packages.map((pkg) => (
                    <Card key={pkg.id} onClick={() => handlePackageSelect(pkg)} className={`flex flex-col text-center cursor-pointer hover:border-cyan-primary/40 group ${pkg.badge === 'Most Popular' ? 'border-cyan-primary/30 ring-1 ring-cyan-primary/20 scale-105' : ''}`}>
                       ...
                       <Button variant={pkg.badge === 'Most Popular' ? 'primary' : 'outline'} className="py-2 text-sm w-full">
                         Select
                       </Button>
                    </Card>
                  ))}
