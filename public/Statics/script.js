...
document.addEventListener('DOMContentLoaded', function() {
        ...
        anchor.addEventListener('click', function (e) {
            ...
            if (mainContentWrapper) {
                ...
                if (hasGSAP) {
                    ...
                    mainContentWrapper.scrollTo({ top: scrollTarget, behavior: 'smooth' });
                }
            } else {
    ...
    if (hasGSAP && hasScrollTrigger && document.querySelector('.title') && document.querySelector('.services-preview')) {
        gsap.to(".title", {
            opacity: 0,
            scrollTrigger: {
